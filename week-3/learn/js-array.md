...
```javascript
var lemari = ['baju', 'celana', 'cangcut', 'kauskaki']

console.log(lemari)       // ['baju', 'celana', 'cangcut', 'kauskaki']
console.log(lemari[0])    // baju
console.log(lemari[1])    // celana

lemari[0] = 'sabuk'

console.log(lemari)       // ['sabuk', 'celana', 'cangcut', 'kauskaki']
console.log(lemari[0])    // sabuk
console.log(lemari[1])    // celana
```

Array seperti tumpukan data. Bayangkan sebuah lemari yang berisi beberapa laci di dalamnya. Kita bisa mendorong (push) seperti memasukkan yang baju pada laci pertama, mengeluarkan (pop) yang paling terakhir atau teratas, atau bahkan mengambil beberapa isinya.

```javascript
lemari.push('sepatu')     
console.log(lemari)        // ['sabuk', 'celana', 'cangcut', 'kauskaki', 'sepatu']
animals.pop()
console.log(lemari)        // ['sabuk', 'celana', 'cangcut', 'kauskaki']
```
...
var siswa = ['Sani', 'Anis', 'Kiki', 'Fahri'];
siswa.sort();
console.log(arrChar); // 'Anis', 'Fahri', 'Kiki', 'Sani'
```
